import { Leaf, ShieldCheck, Zap, Heart, Droplets, Sun, Users, Star } from "lucide-react";
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={heroBg} alt="Lifestyles Intra botanical herbs" className="w-full h-full object-cover" />
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-8 py-20">
        <div className="max-w-2xl">
          ...
          <p className="text-primary-foreground/85 text-lg md:text-xl font-body font-light mb-8 leading-relaxed max-w-xl" style={{ animationDelay: "0.2s" }}>
